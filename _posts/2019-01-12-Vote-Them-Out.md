...
What can we do? <strong>#VoteThemOut</strong>

Well, here's a simple web design idea that will solve the problem.  Take one database backend and add a web frontend that lists all the candidates and their constituencies.  Think of those election maps you see on TV during election coverage, and you get the idea.  The site would weigh the candidates on whether they are 1%'ers or 99%'ers and identify the candidate most likely to "vote them out".

For example, if you were looking at an election map showing Trump as a candidate, he would show up Red as the epidemy of all 1%'ers.  Then the map would show the best candidate to support so that no 1%'ers get elected in your constituency.  Simple.  All the information required is freely available from the government.

All we need to do then is stand up and vote.